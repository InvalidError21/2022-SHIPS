...
waypoints = [  # This is our list of waypoints
    [(2.0, 5.0, 0.0), tf.transformations.quaternion_from_euler(0, 0, 0*pi/180)],
    [(2.0, 5.0, 0.0), tf.transformations.quaternion_from_euler(0, 0, 0*pi/180)],
    [(2.0, 5.0, 0.0), tf.transformations.quaternion_from_euler(0, 0, 0*pi/180)],
    [(5.0, 8.0, 0.0), tf.transformations.quaternion_from_euler(0, 0, 0*pi/180)],
    [(5.0, 8.0, 0.0), tf.transformations.quaternion_from_euler(0, 0, 0*pi/180)],
    [(8.0, 8.0, 0.0), tf.transformations.quaternion_from_euler(0, 0, 0*pi/180)],
    [(8.0, 8.0, 0.0), tf.transformations.quaternion_from_euler(0, 0, 0*pi/180)],
    [(32.0, 2.0, 0.0), tf.transformations.quaternion_from_euler(0, 0, 0*pi/180)],
    [(32.0, 2.0, 0.0), tf.transformations.quaternion_from_euler(0, 0, 0*pi/180)],
    [(32.0, 2.0, 0.0), tf.transformations.quaternion_from_euler(0, 0, 0*pi/180)],
    [(32.0, 2.0, 0.0), tf.transformations.quaternion_from_euler(0, 0, 0*pi/180)],
    [(32.0, 2.0, 0.0), tf.transformations.quaternion_from_euler(0, 0, 0*pi/180)],
